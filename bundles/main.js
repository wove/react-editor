...
/***/ function(module, exports, __webpack_require__) {
	...
	var Editor = __webpack_require__(158);

	ReactDOM.render(React.createElement(Editor, null), document.getElementById('editor-app'));
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            'div',
	            { className: 'Editor' },
	            React.createElement(SiteOptions, {
	    ...
	    handleSiteNameChange: function handleSiteNameChange(siteName) {
	    ...
	    updateBlockOrderIDs: function updateBlockOrderIDs() {
	        for (var i = 0; i < this.state.data.blocks.length; i++) {
	            this.state.data.blocks[i].orderID = i + 1;
	        }
	        this.setState({ data: this.state.data });
	    },
	    createNewBlockID: function createNewBlockID() {
	    ...
	    handleBlockMoveClick: function handleBlockMoveClick(blockOrderID, direction) {
	    ...
	    handleBlockDelete: function handleBlockDelete(blockOrderID) {
	        this.state.data.blocks.splice(blockOrderID - 1, 1);
	        this.updateBlockOrderIDs();
	    },
	    handleNewBlockClick: function handleNewBlockClick(blockData, parentBlockOrderID) {
	        this.collapseBlocks();
	    ...
	    handleCollapseBlockClick: function handleCollapseBlockClick(blockID) {
	        var block;
	    ...
	    handleCollapseNewBlocksClick: function handleCollapseNewBlocksClick(blockID) {
	        var block;
	        for (var item in this.state.data.blocks) {
	            if (this.state.data.blocks[item].id === blockID) {
	                block = this.state.data.blocks[item];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FloatingActionButton = __webpack_require__(180);
	var FontIcon = __webpack_require__(196);
	var NewBlockList = __webpack_require__(197);
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var newBlockList = React.createElement(
	            Paper,
	            null,
	            React.createElement(NewBlockList, {
	        ...
	        return React.createElement(
	            ...
	            this.props.data.collapsed ? '' : React.createElement(BlockType, {
	                data: this.props.data,
	    ...
	    handleShowNewBlocks: function handleShowNewBlocks(e) {
	        e.preventDefault();
	        this.props.onCollapseNewBlocksClick(this.props.data.id);
	    },
	    handleBlockDeleteClick: function handleBlockDeleteClick(e) {
	        e.preventDefault();
	        this.props.onBlockDeleteClick(this.props.data.orderID);
	    },
	    handleBlockCollapseClick: function handleBlockCollapseClick(e) {
	        e.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DefaultRawTheme = __webpack_require__(174);
	var ThemeManager = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Spacing = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var blockComponentList = __webpack_require__(198);
	var NewBlockItem = __webpack_require__(199);
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var blockTypes = blockTypeList.map(function (blockType) {
	            return React.createElement(NewBlockItem, {
	                key: blockType,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var RaisedButton = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Transitions = __webpack_require__(173);
	var ColorManipulator = __webpack_require__(176);
	var Typography = __webpack_require__(201);
	var EnhancedButton = __webpack_require__(181);
	var Paper = __webpack_require__(160);
	var DefaultRawTheme = __webpack_require__(174);
	var ThemeManager = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(TextField, {
	                floatingLabelText: 'Add your heading here',
	...
	blockComponentList["Heading"] = module.exports;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(TextField, {
	                floatingLabelText: 'Add your paragraph here',
	                multiLine: true,
	                value: this.props.data.content,
	                onChange: this.handleChange,
	                style: {
	...
	blockComponentList['Paragraph'] = module.exports;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FontIcon = __webpack_require__(196);
	var Paper = __webpack_require__(160);
	var ImageURLField = __webpack_require__(214);
	var OverlayTextField = __webpack_require__(215);
	var blockComponentList = __webpack_require__(198);
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(ImageURLField, {
	                data: this.props.data,
	                onBlockChange: this.props.onBlockChange }),
	            React.createElement(OverlayTextField, {
	                data: this.props.data,
	                onBlockChange: this.props.onBlockChange })
	        );
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    {
	                        float: 'right' },
	                    this.props.data.orderID > 1 ? React.createElement(
	                        FontIcon,
	                        {
	                            className: 'material-icons',
	                    ...
	                    this.props.data.orderID < this.props.blockCount ? React.createElement(
	                        FontIcon,
	                        {
	                            className: 'material-icons',
	    ...
	    handleBlockMoveUpClick: function handleBlockMoveUpClick(e) {
	        this.props.onBlockMoveClick(this.props.data.orderID, "up");
	    },
	    handleBlockMoveDownClick: function handleBlockMoveDownClick(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Paper = __webpack_require__(160);
	var RaisedButton = __webpack_require__(200);
	var SiteNameField = __webpack_require__(218);
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(SiteNameField, {
	                data: this.props.data,
